  ...
  <div class="container">
    ...
    <div class="containerss">
      <div class="content" id="hello">
        ...
        <p>Say goodbye to mealtime stress with the ultimate companion for meal planning,<br>tracking, and tantalizing
          recipes. We can help you find recipes with your ingredients <br>on hand and the time you want to spend
          cooking.</p>
        <div class="link">
    ...
    <div class="content2" id="home">
      ...
      <div class="containerss2">
        ...
        <div class="content3">
          <div class="container4">
            <div class="link">
              <a href="grocery.php" class="hire4">Grocery List</a>
          ...
          <div class="container5">
            <div class="link">
              <a href="calorie.php" class="hire5">Calorie Intake</a>
              <a href="calorie.php" class="grocery">
      ...
      <div class="containerss3">
        <div class="container6">
          <div class="link">
            <a href="saved.php" class="favourite">
              <img src="img/favcolor.png" alt="favourite"></a>
            <a href="saved.php" class="hire6"> Favourite</a>
          </div>
        </div>
        <div class="container6">
          <div class="link">
            <a href="history.php" class="favourite">
              <img src="img/history.png" alt="favourite"></a>
            <a href="history.php" class="hire6"> History</a>
          </div>
        </div>
        <div class="container6">
          <div class="link">
            <a href="feedback.php" class="favourite">
              <img src="img/Rating.png" alt="favourite"></a>
            <a href="feedback.php" class="hire6"> Feedback</a>
          </div>
        </div>
        <div class="space2"></div>
